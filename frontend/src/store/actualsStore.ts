...
interface ActualsStoreState {
  ...
  addToLedger: (transactionId: string, wbsCategory: string, wbsSubcategory: string) => Promise<void>;
  ...
  subscribeWithSelector(
    devtools(
      (set, get) => ({
        ...
        // Transaction operations
        addToLedger: async (transactionId: string, wbsCategory: string, wbsSubcategory: string) => {
          try {
