...
## Overview
This directory contains all project tasks organized by category and status.
...
## Task Categories
1. **Feature-Specific** - Tasks for implementing specific features
2. **Bugs** - Bug fixes and critical issues
3. **General** - Infrastructure, refactoring, documentation, etc.
...
## How to Use
1. Add new tasks to appropriate category file
2. Update status as work progresses
3. Move completed feature tasks to `completed/` directory
4. Archive completed bugs and general tasks (remove or mark as completed)
