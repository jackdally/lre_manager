...
exports.seedRiskCategories = seedRiskCategories;
const database_1 = require("../src/config/database");
const RiskCategory_1 = require("../src/entities/RiskCategory");
async function seedRiskCategories() {
    ...
    const categoryRepo = database_1.AppDataSource.getRepository(RiskCategory_1.RiskCategory);
    try {
